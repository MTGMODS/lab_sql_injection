...
<section class="card shadow-sm">
    <div class="card-body p-4">
        ...
        <dl class="row mb-0">
            ...
            <dd class="col-sm-9"><?= htmlspecialchars($user['password'], ENT_QUOTES, 'UTF-8') ?></dd>
            <dt class="col-sm-3">Телефон</dt>
            <dd class="col-sm-9"><?= htmlspecialchars((string) $user['phone'], ENT_QUOTES, 'UTF-8') ?></dd>
        </dl>
        <p class="small text-muted mt-3 mb-0">Пароль показано навмисно: це «слабка» навчальна система без хешування.</p>
