...
<section class="hero p-4 p-md-5 mb-4">
    <p class="text-uppercase small fw-bold mb-2" style="letter-spacing:.14em;color:#7a4e00;">Кампусна лотерея</p>
    <h1 class="brand display-5">Зареєструйся і тримай свій щасливий квиток</h1>
    <p class="mb-4">Простий навчальний web-ресурс з реєстрацією учасників. Логіни та паролі зберігаються у таблиці <code>users</code> бази SQLite.</p>
...
<section class="card shadow-sm">
    <div class="card-body">
        ...
        <p class="text-muted">Кожна новина відкривається як <code>news.php?id=</code></p>
