...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: radial-gradient(circle at top right, #1f5c45 0, var(--ink) 42%, #07150f 100%);
            min-height: 100vh;
            color: #1b1b1b;
        }
        ...
        .navbar, .card, .hero { background: var(--paper); }
...
<nav class="navbar navbar-expand-lg mb-4">
    <div class="container ticket-wrap">
        ...
        <span class="badge badge-lab me-3">ЗАХИЩЕНА ВЕРСІЯ</span>
        ...
        <div class="collapse navbar-collapse" id="nav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="recommendations.php">Рекомендації</a></li>
                <?php if ($user): ?>
